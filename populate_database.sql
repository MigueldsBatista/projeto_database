...
INSERT INTO QUARTO (NUMERO, CATEGORIA_QUARTO_ID) VALUES
(101, 2), -- Apartamento
(102, 2), -- Apartamento
(103, 2), -- Apartamento
(104, 2), -- Apartamento
...
INSERT INTO PRODUTO (NOME, DESCRICAO, PRECO, TEMPO_PREPARO, ID_CATEGORIA, CALORIAS_KCAL, PROTEINAS_G, CARBOIDRATOS_G, GORDURAS_G, SODIO_MG) VALUES
...
SELECT p.ID_PACIENTE, p.NOME, p.CPF, q.NUMERO AS QUARTO_NUMERO, cq.NOME AS TIPO_QUARTO, e.DATA_ENTRADA
FROM PACIENTE p
JOIN ESTADIA e ON p.ID_PACIENTE = e.ID_PACIENTE
JOIN QUARTO q ON e.ID_QUARTO = q.ID_QUARTO
JOIN CATEGORIA_QUARTO cq ON q.CATEGORIA_QUARTO_ID = cq.ID_CATEGORIA
...
SELECT p.ID_PEDIDO, pa.NOME AS PACIENTE, q.NUMERO AS QUARTO, pe.STATUS, pe.DATA_PEDIDO, c.NOME AS CAMAREIRA
FROM PEDIDO pe
