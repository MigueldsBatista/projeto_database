...
CREATE TABLE IF NOT EXISTS QUARTO (
    ...
    FOREIGN KEY (ID_CATEGORIA_QUARTO) REFERENCES CATEGORIA_QUARTO (ID_CATEGORIA) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS PRODUTO (
    ...
    FOREIGN KEY (ID_CATEGORIA_PRODUTO) REFERENCES CATEGORIA_PRODUTO (ID_CATEGORIA) ON DELETE SET NULL
);
